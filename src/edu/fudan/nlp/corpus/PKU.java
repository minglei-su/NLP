...
import edu.fudan.nlp.pipe.seq.String2SeqWithCrossLabels;
...
//		is.skip(3); //skip BOM
		...
		while(true) {
			...
			tagFilter.add("l");
			tagFilter.add("vn");
			String2SeqWithCrossLabels.tagFilter = tagFilter;
			String2SeqWithCrossLabels.tagDelimer = "/";
			String s = String2SeqWithCrossLabels.genSequenceWithLabelSimple(sent);
			w.write(s);
		}
		r.close();
		w.close();
