...
public class NERTagger {
	...
	public NERTagger(String segmodel, String posmodel,String dict) throws Exception {
		pos = new POSTagger(segmodel,posmodel);
		pos.setDictionary(new Dictionary(dict),true);
	}
	
	public NERTagger(POSTagger posmodel) throws Exception {
		pos = posmodel;
	}
